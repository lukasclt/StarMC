...
public class StreamCommand implements ProxyInterface {
    ...
    public void handleCommand(Context<ProxiedPlayer> context, String url) {
        ...
        String announce = "§6§l" + Constants.SERVER_NAME.toUpperCase() + " §7» §fO nosso " + PrefixType.DEFAULT.getFormatter().format(account.getRank().getDefaultTag()) + account.getUsername() + " §festá em live agora! Acesse§6 " + url;
