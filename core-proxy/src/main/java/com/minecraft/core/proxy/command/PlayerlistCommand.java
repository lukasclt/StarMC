...
public class PlayerlistCommand implements ProxyInterface {
    ...
    public void handleCommand(Context<CommandSender> context) {
        ...
        msg(commandSender, " ");
        msg(commandSender, " §fTotal de contas: §b" + users + " (1.7 = " + v1_7 + " 1.8.x = " + v1_8_x + ")");
        msg(commandSender, " ");
        msg(commandSender, " §fOriginal: §7" + premium_users + " §a(" + ((premium_users * 100) / users) + "%)");
        msg(commandSender, " §fPirata: §7" + cracked_users + " §c(" + ((cracked_users * 100) / users) + "%)");
        msg(commandSender, " ");
    }
