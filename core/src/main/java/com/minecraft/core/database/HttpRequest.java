...
package com.minecraft.core.database;
...
public class HttpRequest {
    ...
    /**
     * Get response as {@link JsonElement} using character set returned from
     * {@link #charset()}
     *
     * @return JsonElement
     * @throws HttpRequestException
    ...
    public JsonElement json() {
        return Constants.GSON.fromJson(body(), JsonElement.class);
    }
