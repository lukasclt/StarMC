...
public class GameScoreboard {
    ...
    static {
        try {
            ...
            if (GameScoreboardReflection.nmsOptionalClass("ScoreboardServer$Action").isPresent()) {
                VERSION_TYPE = VersionType.V1_13;
            } else if (GameScoreboardReflection.nmsOptionalClass("IScoreboardCriteria$EnumScoreboardHealthDisplay").isPresent()) {
                VERSION_TYPE = VersionType.V1_8;
            } else {
                VERSION_TYPE = VersionType.V1_7;
            }

            Class<?> craftPlayerClass = GameScoreboardReflection.obcClass("entity.CraftPlayer");
            Class<?> craftChatMessageClass = GameScoreboardReflection.obcClass("util.CraftChatMessage");
            Class<?> entityPlayerClass = GameScoreboardReflection.nmsClass("EntityPlayer");
            Class<?> playerConnectionClass = GameScoreboardReflection.nmsClass("PlayerConnection");
            Class<?> packetClass = GameScoreboardReflection.nmsClass("Packet");
            Class<?> packetSbObjClass = GameScoreboardReflection.nmsClass("PacketPlayOutScoreboardObjective");
            Class<?> packetSbDisplayObjClass = GameScoreboardReflection.nmsClass("PacketPlayOutScoreboardDisplayObjective");
            Class<?> packetSbScoreClass = GameScoreboardReflection.nmsClass("PacketPlayOutScoreboardScore");
            Class<?> packetSbTeamClass = GameScoreboardReflection.nmsClass("PacketPlayOutScoreboardTeam");

            MESSAGE_FROM_STRING = lookup.unreflect(craftChatMessageClass.getMethod("fromString", String.class));
            CHAT_COMPONENT_CLASS = GameScoreboardReflection.nmsClass("IChatBaseComponent");
            ...
            if (VersionType.V1_8.isHigherOrEqual()) {
                ...
                ENUM_SB_HEALTH_DISPLAY = GameScoreboardReflection.nmsClass("IScoreboardCriteria$EnumScoreboardHealthDisplay");
                ENUM_SB_ACTION = GameScoreboardReflection.nmsClass(enumSbActionClass);
                ENUM_SB_HEALTH_DISPLAY_INTEGER = GameScoreboardReflection.enumValueOf(ENUM_SB_HEALTH_DISPLAY, "INTEGER");
                ENUM_SB_ACTION_CHANGE = GameScoreboardReflection.enumValueOf(ENUM_SB_ACTION, "CHANGE");
                ENUM_SB_ACTION_REMOVE = GameScoreboardReflection.enumValueOf(ENUM_SB_ACTION, "REMOVE");
            } else {
