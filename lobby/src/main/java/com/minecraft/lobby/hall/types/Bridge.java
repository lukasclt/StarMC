...
public class Bridge extends Hall {
    ...
    public Bridge(Lobby lobby) {
        super(lobby, "The Bridge Lobby", "bridgelobby", "THE BRIDGE NO REDEASTRA.COM");
    ...
    public void handleSidebar(User user) {
        ...
        gameScoreboard.updateTitle("§6§lTHE BRIDGE");
        ...
        scores.add(" ");
        scores.add("§eSolo:");
        scores.add(" §fWins: §6" + storage.getData(Columns.BRIDGE_SOLO_WINS).getAsInteger());
        scores.add(" §fWinstreak: §6" + storage.getData(Columns.BRIDGE_SOLO_WINSTREAK).getAsInteger());
        scores.add(" ");
        scores.add("§eDuplas:");
        scores.add(" §fWins: §6" + storage.getData(Columns.BRIDGE_DOUBLES_WINS).getAsInteger());
        scores.add(" §fWinstreak: §6" + storage.getData(Columns.BRIDGE_DOUBLES_WINSTREAK).getAsInteger());
        scores.add(" ");
